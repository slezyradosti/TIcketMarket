  ...
  return (
    <>
      <Menu color="blue" inverted style={{ borderRadius: "0" }}>
        ...
        <MenuItem
          as={Link}
          to="TicketDiscount/my-discounts"
          name="My Discounts"
        ...
        <MenuItem
          as={Link}
          to="TableEvent/my-list"
          name="My Table-Events"
          active={activeItem === "my_table_events"}
          onClick={() => handleItemClick("my_table_events")}
        />
        <MenuItem
          as={Link}
          to="Ticket/events-tickets"
          name="Events Tickets"
          active={activeItem === "events_tickets"}
          onClick={() => handleItemClick("events_tickets")}
        />
