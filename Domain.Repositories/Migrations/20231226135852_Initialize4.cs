    ...
    public partial class Initialize4 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TableEvent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TableEvent_EventTable_TableId",
                        column: x => x.TableId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableEvent_EventId",
                table: "TableEvent",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_TableEvent_TableId",
                table: "TableEvent",
                column: "TableId");
